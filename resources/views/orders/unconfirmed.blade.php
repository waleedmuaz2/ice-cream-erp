...
<ol class="breadcrumb">
  <li class="breadcrumb-item">
   ...
   <li class="breadcrumb-item active">Unconfirmed Orders</li>
</ol>
<div class="row">
  <div class="col-md-12">
    <div class="card mb-3">
      <div class="card-header">
        ...
        <div class="col-md-10 pull-right">
          ...
          @endif
          <form method="post" action="{{ route('unconfirmed.orders' ) }}">
                {{ csrf_field() }}
                <div class="row">
...
<div class="modal fade" id="order-unapprove-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-secondary confirm-btn">No</button>
        <button class="btn btn-primary confirm-btn send-to-unapprove">Yes</button>
      </div>
    </div>
  </div>
</div>
